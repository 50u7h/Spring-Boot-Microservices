...
public class OrderMessagingDataMapper {
    ...
    public RestaurantApprovalRequestAvroModel orderPaidEventToRestaurantApprovalRequestAvroModel(OrderPaidEvent orderPaidEvent) {
        ...
        return RestaurantApprovalRequestAvroModel.newBuilder()
                ...
                .setOrderId(order.getId().getValue().toString())
                .setRestaurantOrderStatus(org.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus
                        .valueOf(order.getOrderStatus().name()))
                .setProducts(order.getItems().stream().map(orderItem ->
                        org.food.ordering.system.kafka.order.avro.model.Product.newBuilder()
    ...
    public PaymentResponse paymentResponseAvroModelToPaymentResponse(PaymentResponseAvroModel paymentResponseAvroModel) {
        ...
        return PaymentResponse.builder()
                ...
                .paymentStatus(org.food.ordering.system.domain.valueobject.PaymentStatus.valueOf(
    ...
    approvalResponseAvroModelToApprovalResponse(RestaurantApprovalResponseAvroModel restaurantApprovalResponseAvroModel) {
        ...
        return RestaurantApprovalResponse.builder()
                ...
                .orderApprovalStatus(org.food.ordering.system.domain.valueobject.OrderApprovalStatus.valueOf(
